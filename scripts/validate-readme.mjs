...
for (const command of ["init", "start", "upgrade-project", "record-decisions", "resume", "reset-project", "status", "assign", "assignments", "bind-agent", "reconcile", "drive", "acquire-writer", "release-writer", "risk", "validate-artifacts", "gate", "auth-state", "delete-auth-state", "publish-checkpoint", "merge-pr", "doctor"]) {
