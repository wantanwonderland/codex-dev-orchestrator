...
export function evaluateToolUse(input: ToolUseInput, lease?: WriterLease): PolicyDecision {
  ...
  if (mutating && (!lease || !input.session_id || lease.sessionId !== input.session_id)) {
